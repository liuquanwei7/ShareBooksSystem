            ...
            <div class="modal-body">
                <form class="form-horizontal" action="userLoginAction"  namespace="/bookUi" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="user.userAccount"  placeholder="username"  required="required">
                        </div>
                    </div>
                    <!--密码框-->
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="user.userPassword" id="passwords" placeholder="password" required="required">
                        </div>
                    </div>
                    <!--记住密码-->
                    <div class="form-group">
                    ...
                    <form class="form-horizontal" action="userRegisterAction"  namespace="/bookUi" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2" style="display: flex; flex-direction: row">
                                男<input type="radio" name="user.userGender" value="男"/>
                                女<input type="radio" name="user.userGender" value="女"/>
