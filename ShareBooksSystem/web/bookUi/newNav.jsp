...
<%--<head>--%>
    <%--<title>Title</title>--%>
    <%--&lt;%&ndash;<script src="//unpkg.com/vue/dist/vue.js"></script>&ndash;%&gt;--%>
...
<%--<div id="app" class="apps">--%>
    ...
    <%--<i-menu mode="horizontal" :theme="theme1" active-name="1" >--%>
        ...
        <%--&lt;%&ndash;<menu-item name="1" style="float: right;">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<icon type="ios-paper"></icon>&ndash;%&gt;--%>
        <%--&lt;%&ndash;内容管理&ndash;%&gt;--%>
        <%--&lt;%&ndash;</menu-item>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<menu-item name="2"  style="float: right;">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<icon type="ios-people"></icon>&ndash;%&gt;--%>
        <%--&lt;%&ndash;用户管理&ndash;%&gt;--%>
        <%--&lt;%&ndash;</menu-item>&ndash;%&gt;--%>
        ...
        <%--<submenu name="2" style="float: right;">--%>
            ...
            <%--&lt;%&ndash;<menu-group title="使用">&ndash;%&gt;--%>
            <%--&lt;%&ndash;<a href="addBook.jsp"><menu-item name="3-1">新增和启动</menu-item></a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<menu-item name="3-2">活跃分析</menu-item>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<menu-item name="3-3">时段分析</menu-item>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</menu-group>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<menu-group title="留存">&ndash;%&gt;--%>
            <%--&lt;%&ndash;<menu-item name="3-4">用户留存</menu-item>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<menu-item name="3-5">流失用户</menu-item>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</menu-group>&ndash;%&gt;--%>
        <%--</submenu>--%>
    ...
    <%--</i-menu>--%>
    <%--<br>--%>
    <%--&lt;%&ndash;<p>Change theme</p>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<radio-group v-model="theme1">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<radio label="light"></radio>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<radio label="dark"></radio>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<radio label="primary"></radio>&ndash;%&gt;--%>
...
<div id="app" class="apps">
    ...
    <i-menu mode="horizontal" :theme="theme1" active-name="1" >
        ...
        <%--用户管理--%>
        <%--</menu-item>--%>
        <a href="homepage.jsp"><menu-item name="4" style="float: right;">
            <icon type="settings"></icon>
            退出登录
        </menu-item></a>
        <a href="../bookUser/showMyBorrowCarAction.action"><menu-item name="3" style="float: right;">
            <icon type="settings"></icon>
            借阅车
        </menu-item></a>
        ...
        <submenu name="1" style="float: right;">
            ...
            <a href="borrows.jsp"><menu-item name="1-1">已借图书</menu-item></a>
            <a href="../bookUser/showMyBookAction.action"><menu-item name="1-2">个人图书</menu-item></a>
            <a href="../bookUser/addBook.jsp"><menu-item name="1-3">添加图书</menu-item></a>
    ...
    var Main = {
        ...
        methods:{
            getCheckData:function(){
                if(this.myData!==''){
                    location.href="../bookUser/getCheckBookAction.action?check_data="+this.myData;
                }else{
